...
## Generated on : Thu Oct 29 10:03:16 2015
## MATLAB Coder version: 2.7 (R2014b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/madd.a
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/netiger/Desktop/matlabCodeGeneration
ARCH                      = maci64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/madd.a
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/codegen/lib/madd -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=madd -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/codegen/lib/madd/madd_initialize.c $(START_DIR)/codegen/lib/madd/madd_terminate.c $(START_DIR)/codegen/lib/madd/madd.c $(START_DIR)/codegen/lib/madd/rt_nonfinite.c $(START_DIR)/codegen/lib/madd/rtGetNaN.c $(START_DIR)/codegen/lib/madd/rtGetInf.c
...
OBJS = madd_initialize.o madd_terminate.o madd.o rt_nonfinite.o rtGetNaN.o rtGetInf.o
...
%.o : $(START_DIR)/codegen/lib/madd/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/madd/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
